(define (problem los-ascensores-temporal)
 (:domain ascensores-temporal)
 (:objects
 ...
 (:init 
      ...
      (at ascensor-lento-2-0 planta-5)
      (at ascensor-lento-2-1 planta-7)
      (at ascensor-lento-3 planta-12)
      (at ascensor-rapido planta-0)

      (at pasagero-0 planta-1)
      (at pasagero-1 planta-1)
 ...
 (:goal (and
      (at pasagero-0 planta-11)
      (at pasagero-1 planta-11)
      (at pasagero-2 planta-11)
      (at pasagero-3 planta-11)
      (at pasagero-4 planta-11)
 ))
